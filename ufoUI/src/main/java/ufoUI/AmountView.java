...
import com.ufotech.ufo.ufoUI.R;

/**
 * 作者 : octupos2016
 * Github : https://github.com/octupos2016/AmountView
 *
 * textSize (float) : 字体大小,默认8sp
 * currentValue (int) : 设置要显示的数值,默认使用最小值
 * minValue (int) : 最小值,默认1，设置的值不能小于1
 * maxValue (int) : 最大值,默认99，不能小于最小值
 */
