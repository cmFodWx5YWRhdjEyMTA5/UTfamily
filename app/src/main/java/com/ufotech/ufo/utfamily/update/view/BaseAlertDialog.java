package com.ufotech.ufo.utfamily.update.view;
...
public abstract class BaseAlertDialog<T extends BaseAlertDialog<T>> extends BaseDialog {
    ...
    /** btn text(按钮内容) */
    protected String btnLeftText = context.getString(R.string.CheckAppUpdate_download_cancel);
    protected String btnRightText = context.getString(R.string.CheckAppUpdate_download_ok);
    protected String btnMiddleText = context.getString(R.string.CheckAppUpdate_download_continue);
    ...
    public void setUiBeforShow() {
        ...
        tv_title.setText(TextUtils.isEmpty(title) ? context.getString(R.string.CheckAppUpdate_tips) : title);
